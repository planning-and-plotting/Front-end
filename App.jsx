    ...
    <div className="absolute bg-[#110101] text-white w-full h-full">
      ...
      <div className="flex w-full h-1/2 bg-white text-black p-6 mt-4">
        <div className="w-full h-full md:w-7/10 p-4">
          ...
          <p className="mb-4">
            Richco Trust Company Limited stands in its pride in
            delivering quality petroleum to their most cherished customers. All
            this is possible through our working relationship with Goil PLC.
          </p>
          <p>
            Richco Trust Company Limited is interested in
            providing the best service when it comes to oil haulage. Our fleet
            of trucks are well serviced and equipped, and we have professional
            drivers who follow all safety protocols when doing this delivery.
          </p>
        </div>
